...
public class ViewFileBackgroundWorker extends AsyncTask<String, Void, List<String>>{
    ...
    protected List<String> doInBackground(String... params) {
        ...
        String view_url = "https://mantixcloud.nl/gfo/viewproducts.php";
        String result;
...
//                send data
                ...
                String post_data = URLEncoder.encode("group","iso-8859-1")+"="+URLEncoder.encode(group,"iso-8859-1");
